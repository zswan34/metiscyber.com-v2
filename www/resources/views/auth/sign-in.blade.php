            ...
            <div class="d-flex col-sm-7 col-md-5 col-lg-12 px-0 px-xl-4 mx-auto">
                <div class="w-100">
                    @if(request('session') === 'expired')
                        <span class="alert bg-red-lighter italic absolute w-full text-danger rounded-0" style="left: 0px; top: 0px;"><i class="fas fa-exclamation-circle mr-2"></i> You have been logged out due inactivity.</span>
                    @endif
                    <!-- Logo -->
                    ...
                    <h4 class="text-center text-black font-weight-normal mt-5 mb-0">Login to MetisNet</h4>
                    ...
                    <!-- Form -->
                    <form id="sign-in-form" class="mb-5 mt-4" action="{{ route('post-sign-in') }}" method="post" autocomplete="off">
